...
<body>
    ...
    <div id="sub_content">
        ...
        th:object="${userBean}">
            ...
            <div class="col-auto">
                <button type="button" class="btn btn-secondary " onclick="location.href = 'toaddUser';">
                    Add
                </button>
    
            </div>
            <div class="col-auto">
               <a th:href="@{/allUser}"> <button type="button" class="btn btn-danger mb-3">Reset</button></a>
            </div>
        </form>
     <div style="color:red;"><p th:text="${error}"></p></div>
        <table class="table table-striped" id="stduentTable">
            ...
            <tbody>
                ...
                <td>
                   <a th:href ="@{/toupdateUser/{id}(id=${data.uid})}"> <button type="button" class="btn btn-success  " >
                        Update
                    </button></a>
                </td>
                <td><a th:href="@{/deleteUser/(id=${data.uid})}"><button type="submit" class="btn btn-secondary mb-3" data-bs-toggle="modal"
                     data-bs-target="#exampleModal">Delete</button></a></td>
