...
<body>
    ...
    <div id="sub_content">
        <form th:action="@{/updateUser}" method="post" th:object="${userBean}">
        ...
        <div style="color:red;"><p th:text="${error}"></p></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" th:field="*{uid}" class="form-control" id="u_id" placeholder="Id User" readonly="readonly" >
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text"  th:field="*{password}"  class="form-control" id="name"  placeholder="Password">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="text" name="con_password"  class="form-control" id="confirmPassword" placeholder="Confirm Password">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = '/allUser';">
                Back
            </button>
