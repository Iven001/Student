...
<body>
    <div id="testheader">
        <div class="container">
            <div class=row>        
                <div class="col-md-5 ">
            <a th:href="@{/welcome}" style="pointer-events:none;"><h3>Student Registration</h3></a>
        </div>  
        <div class="col-md-6">
    ...
    <div class="sidenav">
        ...
        <button class="dropdown-btn" > Class Management <i class="fa fa-caret-down"></i></button>
          ...
          <a href="@{/toaddCourse}" style="pointer-events:none;">Course Registration </a>
          <a th:href="@{/toaddStudent}" style="pointer-events:none;">Student Registration </a>
          <a th:href="@{/allStudent}" style="pointer-events:none;">Student Search </a>
        </div>
        <a th:href="@{/allUser}" style="pointer-events:none;">Users Management</a>
      </div>
      <div class="main_contents">
    <div id="sub_content">
        <form th:action="@{/newUser}" method="post" th:object="${userBean}">
