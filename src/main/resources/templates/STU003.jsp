...
<body>
  <div id="testheader">
    ...
    <div id="sub_content">
      ...
      <form class="row g-3 mt-3 ms-2" th:action="@{/search}" method="get" 
      th:object="${dto}">
        <div class="col-auto">
          <label for="staticEmail2" class="visually-hidden">studentID</label>
          <input type="text" name="sid" class="form-control" id="staticEmail2" placeholder="Student ID">
        </div>
        <div class="col-auto">
          <label for="inputPassword2" class="visually-hidden">studentName</label>
          <input type="text" name="sname" class="form-control" id="inputPassword2" placeholder="Student Name">
        </div>
        <div class="col-auto">
            <label for="inputPassword2" class="visually-hidden">Course</label>
            <input type="text" name="cname" class="form-control" id="inputPassword2" placeholder="Course">
          </div>
        <div class="col-auto">
      ...
      <table class="table table-striped" id="stduentTable">
        ...
        <tbody>
          <tr th:each="data: ${list}">
            ...
            <td>
        <a th:href="@{/to(id=${data.sid})}"><button type="button" class="btn btn-secondary mb-2">See More</button></a>
