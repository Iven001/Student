...
<body>
    <div id="testheader">
        <div class="container">
            <div class=row>        
                <div class="col-md-5 ">
            <a th:href="@{/allUser}"><h3>Student Registration</h3></a>
        </div>  
        <div class="col-md-6">
    ...
    <div id="sub_content">
        <form th:action="@{/addStudent}" method="post" th:object="${studentBean}">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" th:field="*{sid}" class="form-control" placeholder="Student Id" id="studentID" >
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="date" th:field="*{dob}"  class="form-control" id="dob" placeholder="dob">
                </div>
            </div>
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" value="Female" th:field="*{gender}" id="gridRadios2" >
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" th:field="*{ph}"  class="form-control" id="phone" placeholder="Phone Number">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
