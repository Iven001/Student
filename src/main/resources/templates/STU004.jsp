...
<body>
  <div id="testheader">
    ...
    <div id="sub_content">
      ...
      <form class="row g-3 mt-3 ms-2" th:action="@{/search3}" method="post" 
      th:object="${dto}">
        <div class="col-auto">
          <label for="staticEmail2" class="visually-hidden">studentID</label>
          <input type="text" th:field="*{sid}" class="form-control" id="staticEmail2" placeholder="Student ID">
        </div>
        <div class="col-auto">
          <label for="inputPassword2" class="visually-hidden">studentName</label>
          <input type="text" th:field="*{sname}" class="form-control" id="inputPassword2" placeholder="Student Name">
        </div>
        <div class="col-auto">
            <label for="inputPassword2" class="visually-hidden">Course</label>
            <input type="text" th:field="*{course}" class="form-control" id="inputPassword2" placeholder="Course">
          </div>
        <div class="col-auto">
      ...
      <table class="table table-striped" id="stduentTable">
        ...
        <tbody>
          <tr th:each="data: ${list}">
            ...
            <td th:text="${data.sid}"></td>
            <td th:text="${data.sname}"></td>
            <td><p th:each="course : ${data.courses}"><span th:text="${course.cname}"></span></p></td>
            <td>
        <a th:href="@{/toupdate/{id}(id=${data.sid})}"><button type="submit" class="btn btn-secondary mb-2">See More</button></a>
