...
<body>
    ...
    <form th:action="@{/addCourse}" method="post" th:object="${courseBean}" >
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" th:field="*{cid}"  class="form-control" id="id" placeholder="Course Id">
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text"  th:field="*{cname}"  class="form-control" id="name" placeholder="Course Name">
            </div>
        </div>
